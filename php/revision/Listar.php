...
<body>
    <div class="container">
        <h1 class="title">Listado de Revisiones</h1>
                ...
                <tbody>
                    <?php while ($revision = mysqli_fetch_assoc($resultado)): ?>
                        <tr>
                            ...
                            <td><?= htmlspecialchars($revision['fegreso']) ?: '-' ?></td>
                            ...
                            <td>
                                <a class="btn-modificar" href="./Modificar.php?cod_revision=<?= $revision['cod_revision'] ?>">
                                    Modificar
                                </a>
                            </td>
                            <td>
                                <a class="btn-eliminar" href="./Eliminar.php?cod_revision=<?= $revision['cod_revision'] ?>">
                                    Eliminar
                                </a>
                            </td>
                        </tr>
        ...
        <?php else: ?>
            <p class="mensaje-vacio">No hay revisiones registradas.</p>
        <?php endif ?>
